...
updateDate: 2026-02-23T18:33:10+09:00
relatedArticles: []
---
...
炭素原子が球状につながった分子で、特にサッカーボール状の $\mathrm{C_{60}}$ (バックミンスターフラーレン) が有名です。

```md:buckminsterfullerene
...
環状π共役系化合物で、中心に $\mathrm{Fe^{2+}}$ や $\mathrm{Mg^{2+}}$ などの金属イオンを包接します。多くの誘導体が生体中に存在するほか、色素分子の骨格にもみられます。
