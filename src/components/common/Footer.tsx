...
const Footer = ({ currentPath }: Props) => {
	...
	const metas = routes.getRootPageMetaAll(["Home", "About", "Library", "Blog", "Readme"]);
	return (
		<footer class="mt-8 w-full sticky top-[100dvh] h-8 lg:h-12 text-muted-foreground">
			<nav class="lg:ml-[4rem] border-t border-muted-background">
